...
**Exploratory Data Analysis:** Summarized key insights about total reviews, average price, and availability based on room types and neighborhoods to find relationships between variables in the dataset.
