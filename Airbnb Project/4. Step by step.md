...
![*Data sourced from Airbnb*](Airbnb Project/images/1.PNG){width="569"}

![*Creating Data warehouse*](Airbnb Project/images/2.PNG)

![*Importing multiple tables*](Airbnb Project/images/3.PNG)

![*Configuration for data import*](Airbnb Project/images/4.PNG)

![*Import of 2nd data table*](Airbnb Project/images/5.PNG)
