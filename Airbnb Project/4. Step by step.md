...
**Handling Missing Values:** Identified missing data in 2 Columns: "last review" & "reviews per month"; used JOIN functions to populate missing data.

![SQL 1](images/SQL_1.PNG)

*Fig 6. Query 1 

![Result 1](images/6.PNG)
*Fig 7. Snippet of Query 1 result
